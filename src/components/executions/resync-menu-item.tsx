 ...
 */
export function ResyncMenuItem({ sessionId }: { sessionId: string }) {
  ...
  return (
    <button
      ...
      title="Force-resync this session. Kills the current Claude subprocess (interrupting any turn in flight), replays the transcript from disk, and redispatches any unanswered user message. Use when the session feels stuck and the automatic recovery hasn't caught up."
    >
