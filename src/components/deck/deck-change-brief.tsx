...
/**
 * Earlier versions of today's deck: the revert escape hatch. Shared by the
 * classic change brief and the focused layout's "Today" section header.
 */
...
/**
 * The "what changed since yesterday" brief (classic layout). Summarizes the
 * reconciliation (carried / new / moved off) and hosts the escape hatch —
 * revert to an earlier version of today's deck. Nothing here is a surprise:
 * every change is named, and every prior deck is one tap away.
 */
