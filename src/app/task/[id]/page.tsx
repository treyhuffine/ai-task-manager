...
import {
  ChevronLeft, Trash2, MoreHorizontal, Archive, Check,
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {task ? (
          <div className="space-y-0">
            ...
            <div className="pt-1">
              ...
              <p className="text-[10px] text-muted-foreground/50 mt-1">
                ...
                {task.updated_at !== task.created_at && (
                  <> &middot; Edited {new Date(task.updated_at).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}</>
                )}
                {task.completed_at && (
                  <> &middot; Completed {new Date(task.completed_at).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}</>
                )}
              </p>
            </div>
            ...
            {/* Subtasks */}
            <SubtaskSection parentId={task.id} onOpenTask={(id) => router.push(`/task/${id}`)} />
