...
An independent review of P0 and P1 at 46a2b02 found 11 issues (4 high, 7 medium). All are fixed, with the reviewer's probes kept as regression tests. See the [build notes](homes-build.md#review-of-p0-and-p1-46a2b02).
